...
int main()
{
    ...
    switch(userInput)
    {
        case 1:
            ...
            cin >> numberInput;
            conversions.decimalToBinary(numberInput);
            break;
        case 2:
            cout << "Input an integer: ";
            cin >> numberInput;
            conversions.decimaltoHex(numberInput);
            break;
        case 3:
            cout << "Input a binary number: ";
            cin >> userChar;
            conversions.binaryToDecimal(userChar);
            break;
        case 4:
            //Cheating a little and using a predefined function
            cout << "Input a Hex Number: ";
            cin >> hexNumber;
            cout << conversions.HexToDec(hexNumber);
            break;
        case 5:
            cout<< "Input a binary string ";
            cin >> binaryString;
            cout << conversions.twosCompliment(binaryString);
            break;
        default:
